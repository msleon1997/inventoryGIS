...
class Productos extends DBConnection{

	private $base_url;

    public function __construct() {
        parent::__construct();
        $this->base_url = 'http://localhost:5000/api/productos';
    }
    ...
    public function obtenerProductoPorUser($users_id)
    {
    ...
    public function crearProductos($datos)
    {
        ...
        if ($response) {
            ...
            echo "<script>
                Swal.fire({
                    title: 'Error',
                    text: 'Error al registrar los productos.',
                    icon: 'error',
                    confirmButtonText: 'OK'
                });
            </script>";
...
public function actualizarProductos($id, $datos)
{
    $url = $this->base_url . "/" .$id;
    $opciones = array(
        'http' => array(
    ...
    public function eliminarProductos($id)
    {
        ...
        if ($response) {
            ...
            echo "<script>
                Swal.fire({
                    title: 'Error',
                    text: 'Error al eliminar e producto.',
                    icon: 'error',
                    confirmButtonText: 'OK'
                });
            </script>";
